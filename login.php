<?php
 ...
 include 'check_login.php';
  //if(isset($_SESSION['sname']) and isset($_SESSION['spass']) and isset($_SESSION['role'])){
        ...
        <div class="row w-100 mx-auto">
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
                ...
                <div class="form-group">
                <button type="submit" id="divButton" class="btn btn-primary btn-md"><center>Login</center> <span class="glyphicon glyphicon-log-in"></span></button>
